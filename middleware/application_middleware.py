...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_a4981067d2a24166b1b5a1ac0934909c
    """
    try:
        ...
        auth_package_secret_key = """JpN0-_L0MS6RNoIYYuYgkZJwfHataMmBXx_RPF_6F_8="""
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_f08064fc897a4ea0aaafd9e5e5a051fb
    """
    try:
